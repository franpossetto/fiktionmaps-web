...
export default function Map ()  {    
    ...
    const {fictions, loading: ldg, setLoading,  fictionsSelected, setFictionsSelected, city, setCity} = useMapController();
          ...
          if(fiction.scenes.length > 0){
                fiction.scenes.forEach((scene: any) => {
                    const marker = new google.maps.Marker({
                        position: {lat: scene.location.latitude, lng: scene.location.longitude},
                    ...
                    marker.addListener('click', () => {
                      ...
                      ReactDOM.render( //reemplazable por un react dialog
                        <>
                          <style>{`
