...
export const PlaceImage = ({place}) => {
    ...
    useEffect(() => {
      ...
      const imgDivSideStyle = place.screenshot ? "relative h-36 md:h-96": "relative px-3";
      const imgSideStyle = place.screenshot ? "absolute h-full w-full object-cover":"block h-full w-full object-cover";
  ...
  <div className="relative">
    ...
    >
      {showStreetView ? <FilmIcon className="transform scale-50"/> : <GlobeAmericasIcon className="transform scale-50" />}
    </button>
  </div>
</>
      );
