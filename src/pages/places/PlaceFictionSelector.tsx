...
export const PlaceFictionSelector = () => {
  ...
  const { setFiction } = useSceneController();
  ...
  const handleFictionChange = (fiction: Fiction) => {
    setSelectedFiction(fiction); // Actualiza el estado local
    setFiction(fiction); // Actualiza el estado en SceneController
  };
  ...
  return (
    <Combobox as="div" value={selectedFiction} onChange={handleFictionChange}>
      ...
      <div className="relative mt-2">
        <Combobox.Input
          ...
          displayValue={(fiction: Fiction) => fiction?.name}
          placeholder="You"
        />
