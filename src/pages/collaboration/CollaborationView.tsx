...
const stats = [
  { name: 'Active Cities', value: '15' },
  { name: 'Fictions', value: '365' },
  { name: 'Places', value: '99' },
  { name: 'Scenes', value: '14' },
]
      ...
      <div className="overflow-hidden bg-white shadow sm:rounded-lg p-10">
          ...
          <main>
                ...
                <div>
                  <div className="flex items-center gap-x-3">
                    ...
                    <h1 className="flex gap-x-3 text-base leading-7">
                      <span className="font-semibold text-black">Fiktions</span>
            ...
            <div className="border-t border-white/10 pt-11">
              <h2 className="px-4 text-base font-semibold leading-7 text-black sm:px-6 lg:px-8">Latest drafts</h2>
